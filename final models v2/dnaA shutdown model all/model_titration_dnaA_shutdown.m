...
ht=figure(); 
semilogy(RTlist/60-Ctime/60,Rec_V/(Rec_V(Ctime/dtR)),'linewidth',2); hold all
semilogy(RTlist/60-Ctime/60,Rec_OriC/(Rec_OriC(Ctime/dtR)),'linewidth',2); hold all
semilogy([0 0]/60,[10^-10 10^5],'k--','linewidth',2); hold all
xlim([-3 7]);
ylim([10^-2 10^2])
